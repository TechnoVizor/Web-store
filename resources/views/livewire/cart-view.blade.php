<div> {{-- Корневой элемент Livewire (ОБЯЗАТЕЛЕН) --}}
    ...
    <main class="container mx-auto px-6 py-16 max-w-6xl">
        ...
        <div class="flex items-center space-x-4 mb-12">
            ...
            <div>
                <h1 class="text-3xl font-bold uppercase tracking-tighter text-white">Shopping_Bag</h1>
                <p class="mono text-[10px] text-white/30 uppercase tracking-[0.3em]">Protocol: Terminal_Checkout_v2.1</p>
            </div>
        </div>
        ...
        <div class="flex-grow w-full">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="mono text-[9px] text-white/20 uppercase">Unit_ID: {{ $id }}</p>
                </div>
            ...
            <div class="flex justify-between items-end mt-12">
                ...
                <div class="text-right">
                    <p class="mono text-[9px] text-white/20 uppercase mb-1">Subtotal</p>
...
@endforeach
            ...
            <div class="lg:col-span-1">
                <div class="border border-white/10 p-10 sticky top-24 bg-white/[0.02] backdrop-blur-md">
                    <h2 class="mono text-[10px] uppercase tracking-[0.4em] text-white/20 mb-10 pb-4 border-b border-white/5">Order_Summary</h2>
                    
                    <div class="space-y-6 mb-12">
                        <div class="flex justify-between text-[10px] uppercase mono tracking-widest">
                            <span class="text-white/30">Subtotal_Units</span>
                            <span class="text-white">{{ array_sum(array_column($cartItems, 'quantity')) }}</span>
                        </div>
                        <div class="flex justify-between text-[10px] uppercase mono tracking-widest">
                            <span class="text-white/30">Net_Amount</span>
                            <span class="text-white font-bold">${{ number_format($total, 0) }}</span>
                        </div>
                        <div class="flex justify-between text-[10px] uppercase mono tracking-widest">
                            <span class="text-white/30">Tax_Service</span>
                            <span class="text-white/20">Calculated_At_Checkout</span>
                        </div>
                    </div>

                    <div class="border-t-2 border-white pt-8 mb-12">
                        <div class="flex justify-between items-end">
                            <span class="mono text-[10px] uppercase text-white font-bold">Total_Cost</span>
   ...
   class="block w-full bg-white text-black py-5 text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-neutral-200 transition-all active:scale-[0.98] text-center">
    Confirm_Selection
                    ...
                    <div class="mt-6 flex items-center justify-center space-x-3 opacity-20">
                        ...
                        <span class="mono text-[8px] uppercase tracking-widest">Terminal_Secure_Active</span>
                    </div>
                </div>
            </div>
        </div>
