...
<div class="py-40 flex items-center justify-center">
    <div class="text-center space-y-8 max-w-lg">
        {{-- Индикатор --}}
        <div class="inline-flex items-center justify-center w-20 h-20 border border-white/5 mb-4 bg-white/[0.02]">
        ...
        <div class="pt-10 flex flex-col items-center space-y-6">
            <a href="{{ route('orders.index') }}" wire:navigate 
               class="ui-btn ui-btn-primary px-8 py-3 text-[9px] tracking-widest">
               {{ __('ui.orders.view_history') }}
            </a>
            <a href="{{ route('home') }}" wire:navigate 
               class="ui-btn ui-btn-compact mono text-[8px] tracking-widest">
